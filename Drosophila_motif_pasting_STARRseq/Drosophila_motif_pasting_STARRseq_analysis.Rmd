...
setwd("/groups/stark/almeida/Papers/Random_variant_motif_context_STARRseq/Code/Variant_STARRseq/Drosophila_motif_pasting_STARRseq/")
...
### Fig S10A,B - Replicates scatter plots
...
### Fig S10C - plot enhancer activity of different sequences
...
### Fig 3B, S12A - Activity of pasted motifs across different enhancer positions
...
### Fig S10D - coefficient of variations
...
### Fig S11A,B, 3E - pairwise comparisons between pasted motifs
...
### Fig 3C, S16B,D,F - barplots with examples of motif activity at different positions
...
### Fig S12B - Variance explained by different wildtype and pasted motif identity
...
### Fig S13 - Compare delta between pairs of positions in same enhancer, vs pairs in diff enrhancers
...
### Fig S15 - linear model performances
...
### Fig 4B,C - associations with different features
